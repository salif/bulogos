...
Полезна информация за преводачи на софтуер има компилирана (в смисъла на компилация от данни) в моето хранилище https://github.com/[редактирано]/Bulogos (приемам pull requests).
...
(to add to https://github.com/[редактирано]/Bulogos/BLSG )
