* https://github.com/[редактирано]/Bulogos/blob/master/ALL-DICTS_sorted.md
* plaintext version (версия във вид на „суров текст (с кодировка: UTF-8)“: https://github.com/[редактирано]/Bulogos/raw/master/ALL-DICTS_sorted.md
* 
* 
* 
* # ALL DICTIONARIES - ВСИЧКИ РЕЧНИЦИ - ALL-DICT_sorted7.md
* # Възможно е на места да има дублиращи се редове, както и правописни грешки (typos) или вече неактивни хипервръзки. Ако желаете да предложите редакции, корекции или да добавим други речници към този файл, изпратете ми е-писмо до <[редактирано]> или <[редактирано]>, като споменете името на този файл.
...
* > https://github.com/[редактирано]/Bulogos/ALL-DICTS_sorted_final.md
* bg.Ziezi
